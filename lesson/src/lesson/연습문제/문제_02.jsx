...
function Index0002() {
  ...
  const database = [
    { name: "Kim", age: 19, id: "kimkim", pwd: "kim20" },
  ...
  database.map((data) => {
    if (id === data.id && pwd === data.pwd) {
      if (data.age >= 20) {
        message = "안녕하세요" + data.name;
      } else {
        message = "당신은 미성년자 입니다.";
      }
    }
  });
  ...
  return (
    <div>
      ...
      <div id="lesson-content">
        ...
        <div>
          `id`, `pwd`를 입력 받아서 해당 사용자를 환영하는 `message`를
          작성하시오.
        </div>
        <div>
          만약 `database`에 존재하는 사용자라면, "안녕하세요, OO세 OOO님!"을
          출력하고,
        </div>
        ...
        <div>
          - 힌트: 03_반복문 / 예제_05.jsx 코드의 사용자 환영 메시지 출력
        </div>
